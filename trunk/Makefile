#############################################################################
# Makefile for building: ShuntingYardAlgorithm
# Generated by qmake (2.01a) (Qt 4.4.0) on: Mon Jun 23 22:56:08 2008
# Project:  ShuntingYardAlgorithm.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.4.0/bin/qmake -unix CONFIG+=debug_and_release -o Makefile ShuntingYardAlgorithm.pro
#############################################################################
...
Makefile: ShuntingYardAlgorithm.pro  /usr/local/Trolltech/Qt-4.4.0/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.4.0/mkspecs/common/g++.conf \
	...
	$(QMAKE) -unix CONFIG+=debug_and_release -o Makefile ShuntingYardAlgorithm.pro
